...
export const TOPIC_GROUPS: TopicGroup[] = [
  ...
  {
    name: "Commodities",
    topics: ["commodity prices", "oil prices", "natural gas data", "precious metals", "gold silver prices", "agricultural commodities", "lumber prices", "coal data", "iron ore prices", "commodity futures"],
  },
  {
    name: "Economics & Macro",
    topics: ["economic indicators", "GDP data", "inflation data", "CPI PPI", "unemployment data", "interest rates", "central bank data", "federal reserve", "ECB data", "trade balance", "national accounts", "purchasing managers index"],
  },
  {
    name: "Insurance & Risk",
  ...
  },
  {
    ...
    topics: ["satellite imagery finance", "web scraping finance", "social sentiment trading", "credit card transaction data", "foot traffic data", "job postings economic indicator", "shipping container tracking finance", "ESG data"],
  },
  ...
  },
  {
    ...
    topics: ["solar energy data", "wind energy data", "hydropower", "geothermal data", "renewable energy capacity", "carbon credits", "green hydrogen", "battery storage data", "EV charging stations", "solar irradiance"],
  },
  {
  ...
  {
    name: "Crops & Farming",
    topics: ["crop yield data", "agriculture APIs", "soil data", "crop prices", "planting data", "harvest data", "precision agriculture", "farm management", "crop disease detection", "seed data", "irrigation data"],
  },
  {
  ...
  // === ENVIRONMENT & CLIMATE ===
  {
    ...
    topics: ["climate data", "weather APIs", "historical weather", "climate models", "temperature records", "precipitation data", "storm tracking", "hurricane data", "drought data", "weather forecast APIs"],
  },
  {
  ...
  {
    name: "Public Health",
    topics: ["disease surveillance", "epidemic data", "vaccination data", "mortality data", "morbidity data", "health statistics", "CDC data", "WHO data", "pandemic data", "syndromic surveillance"],
  },
  {
    name: "Clinical & Biomedical",
    topics: ["clinical trials data", "drug data", "FDA data", "adverse events", "medical devices", "genomics data", "proteomics", "electronic health records", "medical imaging datasets", "pathology data"],
  },
  {
  ...
  // === SCIENCE & RESEARCH ===
  {
    ...
    topics: ["chemical databases", "molecular data", "materials science data", "crystal structure data", "polymer data", "spectroscopy data", "chemical properties", "periodic table APIs", "compound data"],
  },
  {
  ...
  // === SPACE & ASTRONOMY ===
  {
    ...
    topics: ["satellite imagery", "satellite tracking", "orbit data", "space weather", "NASA APIs", "ESA data", "asteroid data", "exoplanet data", "star catalogs", "cosmic ray data", "space debris tracking"],
  },
  {
  ...
  },
  {
    ...
    topics: ["code search APIs", "package registry data", "GitHub APIs", "CI CD data", "documentation APIs", "programming language stats", "open source metrics", "license data", "dependency data"],
  },
  {
  ...
  // === GOVERNMENT & PUBLIC SECTOR ===
  {
    ...
    topics: ["census data", "government spending", "public procurement", "legislation data", "voting records", "election data", "lobbying data", "FOIA data", "government contracts", "regulatory data"],
  },
  {
    name: "Law & Legal",
  ...
  {
    name: "Sports",
    topics: ["sports statistics", "football data", "basketball data", "baseball data", "soccer data", "cricket data", "tennis data", "Olympics data", "sports betting odds", "fantasy sports data", "esports data"],
  },
  {
  ...
  // === GEOSPATIAL & MAPPING ===
  {
    ...
    topics: ["geocoding APIs", "map tile APIs", "address validation", "postal code data", "boundary data", "points of interest", "routing APIs", "elevation APIs", "place name data", "coordinate systems"],
  },
  {
